...
public class MySqlCreateDatabase {
    ...
    public MySqlCreateDatabase(Connection connection) {
    ...
    public void createDatabase() {
        ...
        try (Statement statement = connection.createStatement()) {
            if (isDefaultDatabase()) {
                ...
                sendConsoleMessage(String.format(Msg_db_success, database));
            }
    ...
    public void createJobsTable() {
        ...
        try (Statement statement = connection.createStatement()) {
            statement.executeUpdate(sql);
            sendConsoleMessage(String.format(Msg_tableDB_success, table));
        } catch (SQLException e) {
